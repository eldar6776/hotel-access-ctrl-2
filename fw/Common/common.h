...
/* 	                                                                                        */
/**/
#define FW_DATE                                	0x00201008
#define FW_TIME                        			0x00015504 
#define FW_BUILD_NUMBER                          2464
...
#define RT_LOGO_ADDR                            0x90D00000 // room thermostat user logo.png start address
#define RT_LOGO_SIZE                            0x00040000 // logo image max. size 144,000‬ bytes    (360px x 100px x 32bpp)
...
#define DEF_SYSID                       43962U  // default system id 0xabba hex
#define DEF_PASSW                       43962U  // default password  0xabba hex
#define IP_ADDR0                        192U    // ip address msb
#define IP_ADDR1                        168U    // ip address
#define IP_ADDR2                        0U      // ip address
#define IP_ADDR3                        200U    // ip address lsb 
#define SUBNET_ADDR0                    255U    // ip subnet mask msb
#define SUBNET_ADDR1                    255U    // ip subnet mask
#define SUBNET_ADDR2                    255U    // ip subnet mask
#define SUBNET_ADDR3                    0U      // ip subnet mask lsb
#define GW_ADDR0                        192U    // ip gateway address msb
#define GW_ADDR1                        168U    // ip gateway address
#define GW_ADDR2                        0U      // ip gateway address
#define GW_ADDR3                        1U      // ip gateway address lsb
#define MAC_ADDR0                       2U      // Ethernet interface hardware MAC address msb  
#define MAC_ADDR1                       1U      // MAC address
#define MAC_ADDR2                       2U      // MAC address
#define MAC_ADDR3                       0U      // MAC address
#define MAC_ADDR4                       0U      // MAC address
#define MAC_ADDR5                       0U      // Ethernet interface hardware MAC address lsb  
/** ============================================================================*/
...
/** ============================================================================*/
#define DEF_OWBPS                       9600U   // default onewire interface baudrate
#define DEF_OWBRA                       127U    // default onewire broadcast address
#define DEF_HC_OWGRA                    40U     // hotel controller default onewire group address
#define DEF_HC_OWIFA                    31U     // hotel controller default onewire interface address
#define DEF_RC_OWGRA                    20U     // room controller default onewire group address
#define DEF_RC_OWIFA                    11U     // room controller default interface address
#define DEF_CR_OWGRA                    10U     // indoor card reader default onewire group address
#define DEF_RT_OWGRA                    10U     // room thermostat default onewire group address
#define DEF_CR_OWIFA                    2U     	// indoor card reader default interface address
#define DEF_RT_OWIFA                    1U      // room thermostat default interface address
/** ============================================================================*/
/**                 C O U N T E R       C O N S T A N T S                       */
/** ============================================================================*/
#define TXREP_CNT                       2U      // number of repeated packet in broadcast and group link file transfer
...
/** ============================================================================*/
#define OW_BSIZE                        256U    // buffer size
...
#define RT_RST_DRBL                     ((uint8_t)0x53U)
/** ==========================================================================*/
...
/** ==========================================================================*/
#define SET_BRIDGE                      ((uint8_t)0xE0U + COM_Bridge)
#define SET_BRNONE                      ((uint8_t)0xE0U)
#define SET_BR2RS485                    ((uint8_t)0xE1U)
#define SET_BR2RADIO                    ((uint8_t)0xE2U)
#define SET_BR2WIFI                     ((uint8_t)0xE3U)
#define SET_BR2ETH                      ((uint8_t)0xE4U)
#define SET_BR2KNX                      ((uint8_t)0xE5U)
#define SET_BR2X10                      ((uint8_t)0xE6U)
#define SET_BR2NFC                      ((uint8_t)0xE7U)
#define SET_BR2IR                       ((uint8_t)0xE8U)
#define SET_BR2OW                       ((uint8_t)0xE9U)
/** ==========================================================================*/
...
#define BUFFERCNT(__BUFFER__)           (sizeof(__BUFFER__) / sizeof(*(__BUFFER__)))
...
#define FLPROT_SECT                     (~(uint32_t)((1 << FLSECT_NUM) - 1))
/** ============================================================================*/
/**			A S C I I       C O N T R O L       C H A R A C T E R S             */
/** ============================================================================*/
#define NUL     ((char)0x00U)    /* null control char                   */
#define SOH     ((char)0x01U)    /* start of header control character   */
#define STX     ((char)0x02U)    /* start of text control character     */
#define ETX     ((char)0x03U)    /* end of text control character       */
#define EOT     ((char)0x04U)    /* end of transmission control char    */
#define ENQ     ((char)0x05U)    /* enquiry control character           */
#define ACK     ((char)0x06U)    /* acknowledge control character       */
#define BEL     ((char)0x07U)    /* bell control character              */
#define BS      ((char)0x08U)    /* backspace control character         */
#define TAB     ((char)0x09U)    /* horizontal tab control character    */
#define LF      ((char)0x0AU)    /* line feed control character         */
#define VT      ((char)0x0BU)    /* vertical tab control character      */
#define FF      ((char)0x0CU)    /* form feed new page control char     */
#define CRT     ((char)0x0DU)    /* carriage return control char        */
#define SO      ((char)0x0EU)    /* shift out control character         */
#define SI      ((char)0x0FU)    /* shift in control character          */
#define NAK     ((char)0x15U)    /* negative acknowledge control char   */
#define ETB     ((char)0x16U)    /* end of transfer block control char  */
#define CAN     ((char)0x17U)    /* cancel control char                 */
#define SUB     ((char)0x1AU)    /* supstitute control char             */
#define ESC     ((char)0x1BU)    /* escape control char                 */
#define FS      ((char)0x1CU)    /* file separator control char         */
#define GS      ((char)0x1DU)    /* group separator control char        */
#define RS      ((char)0x1EU)    /* record separator control char       */
#define US      ((char)0x1FU)    /* unit separator control char         */
/* Exported type  ----------------------------------------------------- */
/* rs485 scanner command*/
enum
{
    FIND_FIRST  = ((uint8_t) 0x0U),
    FIND_ADDR   = ((uint8_t) 0x1U),
    FIND_NEXT   = ((uint8_t) 0x2U),
    FIND_NEW    = ((uint8_t) 0x3U),
    FIND_ALL    = ((uint8_t) 0x4U)
};
/* flash operation error code */
enum
{
	FLIF_OK = ((uint8_t) 0x0U), 
    FLIF_WRCTRL_ERR = ((uint8_t) 0x1U), 
    FLIF_WR_ERR = ((uint8_t) 0x2U)
};
...
enum
{
	WL_9BIT = ((uint8_t) 0x0U), 
    WL_8BIT = ((uint8_t) 0x1U)
...
extern const uint8_t rtc_month[2][12]; // days in month for leap and non leap year
